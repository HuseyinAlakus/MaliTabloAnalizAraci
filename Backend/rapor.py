...
# Gemini API anahtarınızı buraya koyun veya ortam değişkeninden okuyun
genai.configure(api_key="AIzaSyCbbmCskodgNlDorEN9V3eQAsr35bmP9P8") # Kendi API anahtarınız
gemini_model = genai.GenerativeModel("gemini-2.0-flash")

# --- Grafik Üretme Fonksiyonu ---
...
# --- Yorum temizleme ve düzenleme fonksiyonu (mevcut) ---
def temizle_ve_duzenle_yorum(metin):
    ...
    for satir in satirlar:
        ...
        # Check for heading pattern (e.g., "Madde 1: ...") and include it if it's not just a general heading
